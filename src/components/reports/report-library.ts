  ...
  },
  {
    ...
    reports: [
      ...
      },
      {
        ...
        question: "How does each active setup move from yearly gross through sequential cuts to calculated net and the approved monthly final?",
        description: "Traces each financial setup from yearly gross through both sequential cuts, calculated net, and the entered approved monthly final.",
        timeBasis: "Current active financial setup",
        columnLabels: {
          annualGross: "Yearly gross",
          monthlyGross: "Monthly gross",
          calculatedNet: "Calculated net",
          approvedFinal: "Approved final / month",
