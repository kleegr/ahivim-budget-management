...
export default function ImpersonationBar({
  ...
  return (
    <div
      role="status"
      className="sticky top-0 z-[90] flex h-10 items-center border-b border-[#b78314] bg-[#fff4cf] px-3 text-sm text-[#5f4100] shadow-sm"
    >
      <div className="mx-auto flex w-full max-w-[100rem] items-center justify-between gap-3">
        <p className="min-w-0 truncate">
          Viewing as <strong>{impersonation.target.displayName}</strong>
        </p>
