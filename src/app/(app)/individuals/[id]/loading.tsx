...
/** Instant route-level placeholder while an individual profile loads. */
export default function IndividualDetailLoading() {
  return (
    <div role="status" aria-label="Loading individual">
      {/* PageHeader */}
