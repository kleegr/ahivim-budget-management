    ...
    <>
      ...
      {!result.ok ? <ErrorPanel title="Could not load the statement">{result.error}</ErrorPanel>
        ...
        : <div className="space-y-4">
            <div className="grid border-y border-[var(--color-rule-strong)] bg-[var(--color-surface)] sm:grid-cols-3 sm:divide-x sm:divide-[var(--color-rule)]">
